...
public class Canvas_Cube extends JPanel{
	...
	public final String BLUE="blue";public final String RED="red";
	public final String GREEN="green";public final String ORANGE="orange";
	public final String YELLOW="yellow";public final String WHITE="white";
	...
	/**
	 * 蓝面旋转90度
	 * @param clockWise：ture为顺时针；false为逆时针
	 */
